...
<footer class="footer-section bg-lighter rel z-1">
    {{-- <div class="container">
       <div class="call-to-action bg-blue bgs-cover text-white rel z-1">
            ...
            <img class="white-circle" src="{{asset('frontend/images/shapes/white-circle.png')}}" alt="White Circle">
            <img class="white-dots slideUpRight" src="{{asset('frontend/images/shapes/white-dots.png')}}" alt="shape">
            <img class="white-dots-circle slideLeftRight" src="{{asset('frontend/images/shapes/white-dots-circle.png')}}" alt="shape">
        </div>
        ...
        <div class="copyright-area text-center">
            <p>© 2022 <a href="{{URL::Route('home')}}">Commerce Box.</a> {{__('All rights reserved')}}</p>
        </div>
    </div>
