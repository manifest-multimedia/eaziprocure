...
<x-slot name="title"> 
    EaziProcure &mdash; Dashboard
        ...
        <div class="alert alert-warning"> Welcome back  {{Auth::user()->name}}, you're currently on our forever free plan. <a href="/upgrade">Upgrade</a> to access premium features and services!</div>
